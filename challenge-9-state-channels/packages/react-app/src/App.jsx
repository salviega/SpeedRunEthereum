  ...
  */
  ...
  function recieveVoucher(clientAddress) {
    ...
    function processVoucher(voucher) {
       ...
       */
      const updatedBalanceStringyfied = ethers.utils.formatEther(updatedBalance);
      console.log("updatedBalanceStringyfied: ", updatedBalanceStringyfied);
      console.log("verifyMessage: ", ethers.utils.verifyMessage(clientAddress, voucher.data.signature));
